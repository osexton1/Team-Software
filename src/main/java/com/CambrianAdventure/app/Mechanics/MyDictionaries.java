...
public class MyDictionaries {
        ...
        public MyDictionaries() {
                ...
                randFrost = new ArrayList<>(Arrays.asList("The frosty waters have calmed slightly, but not to a point of comfort. The calcified remains of behemoths that couldn't handle the temperatures litter the seabed.",
                                                                       ""));
                randCaves = new ArrayList<>(Arrays.asList("You swim past a couple of narrow bends and come out into a large cavern. Scattered across the area are hundreds of small glowing jellyfish.",
                                                                       ""));
                randDeep = new ArrayList<>(Arrays.asList("",
                                                                      ""));
                randOpen = new ArrayList<>(Arrays.asList("As you swim forward, you gaze down below you into the depths, and for a moment you could've sworn the depths stared back.",
                                                                      "Suddenly a powerful ocean current sweeps across you and carries you quickly to new waters.",
                                                                     ""));
                randShallow = new ArrayList<>(Arrays.asList("The shallow waters of the tidepool become barren and empty, devoid of plant life or any other creatures. You are alone.",
                ...
                randMeadow = new ArrayList<>(Arrays.asList("",
                                                                        ""));
                randTrop = new ArrayList<>(Arrays.asList("You come across a flatbed within the coral. The clearing is teeming with small critters foraging for food in the sediment.",
                                                                      ""));
                ...
                biomeType = new ArrayList<>(Arrays.asList("The landscape changes as you move forward." +
                ...
                eventEvent = new ArrayList<>(Arrays.asList("There is only one way forward. You will have to travel in that direction.",
                                                                       ""));
                eventPuzzle = new ArrayList<>(Arrays.asList("A chill passes down your carapace. This locale is particularly unique.",
                                                                       ""));
                eventEncounter = new ArrayList<>(Arrays.asList("You feel on edge. A quick scan of the area confirms your caution.",
                                                                       ""));
                
                creatures = new ArrayList<>(Arrays.asList("",
                                                                      ""));
                
                numPaths = new ArrayList<>(Arrays.asList("",
